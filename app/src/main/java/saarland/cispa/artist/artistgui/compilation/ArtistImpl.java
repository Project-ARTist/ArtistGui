...
import saarland.cispa.artist.artistgui.compilation.thread.ArtistInterruptedException;
import saarland.cispa.artist.artistgui.compilation.thread.ArtistThread;
...
public class ArtistImpl implements Artist {
    ...
    public boolean mergeCodeLib(final Context context,
        ...
        Log.d(TAG, "MergeCodeLib into: " + runConfig.app_apk_file_path);
        ...
        if (runConfig.codeLib != null) {
            ...
            final MergeConfig mergeConfig = new MergeConfig(runConfig.codeLib.getName(),
                    runConfig.app_apk_merged_file_path, runConfig.app_apk_file_path);
    ...
    private String resignApk(final String unsignedApkPath) {
        ...
        final ApkSigner apkSir = new ApkZipSir(config.app_apk_merged_signed_file_path);
        try {
