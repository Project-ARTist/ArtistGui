...
import com2.android.dx.util.MutabilityControl;
import java.util.HashMap;
import java.util.List;

/**
 * Container for local variable information for a particular {@link
 * com2.android.dx.ssa.SsaMethod}.
 * Stolen from {@link com2.android.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link com2.android.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link com2.android.dx.rop.type.TypeBearer} (such as a constant value).
     *
